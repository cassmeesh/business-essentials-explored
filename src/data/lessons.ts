    ...
    quiz: [
      {
        ...
        feedback: {
          ...
          incorrect: "Not quite. Stoneridge Software and Levridge are actually two connected but distinct companies — both part of the Stoneridge family."
        }
      }
    ]
  },
          ...
          items: [
            {
              ...
              content: "The majority of Stoneridge's revenue comes from consulting services. Clients pay us for the time and expertise of our consultants through either time-and-materials or subscription-based arrangements. This includes software implementations, ongoing system support, and project work."
            },
            {
              title: "Product Licensing Resale",
              content: "As a Microsoft partner, Stoneridge purchases software licenses from Microsoft and other third-party vendors, applies a markup, and resells them to clients. This is a growing revenue stream for the company."
            },
            {
              title: "Partner Incentives",
              content: "We receive partner incentives from Microsoft for selling licenses and completing qualifying activities. These incentives reward us for growing the Microsoft ecosystem."
            }
          ]
        },
        {
    ...
    quiz: [
      {
        ...
        correctIndex: 2,
        feedback: {
          correct: "Exactly! Consulting services — where clients pay for our expertise and time — is the primary revenue source for Stoneridge Software.",
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            {
              title: "People Costs",
              content: "Salaries and benefits for consultants and subcontractors represent the largest expense. As a people-driven business, our team IS our product."
            },
            {
              title: "License Costs",
              content: "We purchase Microsoft and third-party licenses that we then resell to clients. These costs are offset by the markup we apply."
            },
            {
              title: "Operational Costs",
              content: "Internal teams, tools, marketing, training, and office expenses all contribute to running the business effectively."
            }
          ]
        },
        {
    ...
    quiz: [
      {
        ...
        feedback: {
          ...
          incorrect: "Not quite. Since Stoneridge is a consulting company, our biggest expense is people — specifically salaries and benefits for our consultants."
        }
      }
    ]
  },
          ...
          items: [
            {
              ...
              content: "Levridge's core revenue comes from subscription licensing. Clients pay recurring fees to access and use the platform — similar to how you might subscribe to Netflix or Microsoft 365. As more agribusinesses adopt Levridge, this recurring revenue grows."
            },
            {
              title: "Feature & Add-On Revenue",
              content: "Levridge also generates revenue through add-on features and enhancements. These may include advanced integrations or specialized workflows requested by clients. These are typically one-time or project-based fees on top of the base subscription."
            },
            {
    ...
    quiz: [
      {
        ...
        correctIndex: 1,
        feedback: {
          correct: "Correct! Levridge's core revenue comes from subscription licensing — recurring fees clients pay to access and use the platform.",
          incorrect: "Actually, Levridge primarily earns revenue through subscription licensing — recurring fees that clients pay on an ongoing basis."
        }
      }
    ],
    matching: [
          ...
          items: [
            {
              ...
              content: "Stoneridge Software is a consulting business (revenue from billable time). Levridge is a product/SaaS business (revenue from subscriptions)."
            },
            {
              title: "Connected But Distinct",
              content: "While they work closely together, each company has its own focus, leadership, and growth strategy."
            },
            {
              title: "Industry Expertise",
              content: "Both companies share a commitment to deep industry knowledge, particularly in agriculture, food & beverage, and manufacturing."
            },
            {
